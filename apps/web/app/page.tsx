...
const trustPoints = [
  {
    ...
    body: "Your birth data stays connected to your private account."
  },
  {
    icon: "compass",
    title: "Precise & personal",
    body: "Built from your exact birth data, not a generic sun-sign horoscope."
  },
  {
    icon: "spark",
    title: "Useful immediately",
    body: "Your first Today’s Brief is waiting at the end of setup."
  }
];
...
const setupSteps = [
  {
    ...
    body: "Add your name and private account details."
  },
  {
    index: "02",
    title: "Add your birth details",
    body: "Your date, time, and place create the chart behind every reading."
  },
  {
    index: "03",
    title: "Open today’s guidance",
    body: "CosmoScope calculates your chart and takes you directly to your first Today’s Brief."
  }
];
      ...
      <section className="hero-shell">
        <nav className="cosmoscope-nav" aria-label="Primary navigation">
          ...
          <div className="nav-actions">
            <a className="nav-login" href="/app?mode=login">Log in</a>
