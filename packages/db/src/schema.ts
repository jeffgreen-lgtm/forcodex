...
create table if not exists public.user_profiles (
  ...
  birth_input_hash text,
  birth_input_version text not null default 'birth-input-v1',
...
create table if not exists public.forecast_cache (
  ...
  birth_input_hash text,
  chart_source_version text,
  astrology_sources jsonb,
  interpretation_packet jsonb,
